...
<section>
    <div class="container mt-3 ">
        <div class="row g-2 ">
            ...
            <div class="col-md-4  col-sm-12 col-lg-4">
                <div class="wrap border rounded d-flex align-items-center ps-2 justify-content-center flex-column "  style="height: 200px;background: #DB4437">
                    <h5 class="text-light">Total Reviews</h5>
        ...
        <div class="row g-2 ">
            ...
            <div class="col-md-12  col-sm-12 col-lg-12">
                <div class="wrap border rounded  p-2" >
                    <form action="/google-proceess" class="form" method="post">
                        @csrf
                        <div class="row">
